<template>
  <content-wrap>
    ...
    >
      ...
      <el-table-column align="center" prop="visible" label="显示状态" width="100">
        <template #default="{ row }">
    ...
    <!-- 添加或修改菜单对话框 -->
    <Dialog v-model="open" :title="title" width="700">
        ...
        <el-row>
          ...
          <el-col v-if="form.menuType != 'F'" :span="12">
            <el-form-item label="菜单图标" prop="icon">
              <IconPicker class="w-full" v-model="form.icon" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="菜单名称" prop="menuName">
          ...
          <el-col v-if="form.menuType != 'F'" :span="12">
            <el-form-item>
              ...
              <el-switch v-model="form.isFrame" active-text="是" inactive-text="否" :active-value="0" :inactive-value="1" inline-prompt />
            </el-form-item>
          </el-col>
          <el-col v-if="form.menuType != 'F'" :span="12">
          ...
          <el-col v-if="form.menuType != 'F'" :span="12">
            <el-form-item>
              ...
              <el-switch v-model="form.visible" active-text="显示" inactive-text="隐藏" active-value="0" inactive-value="1" inline-prompt />
            </el-form-item>
          </el-col>
          <el-col v-if="form.menuType != 'F'" :span="12">
            <el-form-item>
              ...
              <el-radio-group v-model="form.status">
                <el-switch v-model="form.visible" active-text="正常" inactive-text="停用" active-value="0" inactive-value="1" inline-prompt />
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
