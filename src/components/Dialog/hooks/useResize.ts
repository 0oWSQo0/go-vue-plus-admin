...
export const useResize = (props?: { minHeightPx?: number; minWidthPx?: number; initHeight?: number; initWidth?: number }) => {
  const { minHeightPx = 400, minWidthPx = window.innerWidth / 2, initHeight = 400, initWidth = window.innerWidth / 2 } = props || {}
  // 屏幕宽度的 50% 作为最小宽度
